...
void flightbox::OnGyroReadingChanged(Gyrometer^sender, GyrometerReadingChangedEventArgs ^args){
	...
	motors[0] = offset + (rollRateG[0] * rollRateE + rollRateG[1] * rollRateEint) / 2 + (pitchRateG[0] * pitchRateE + pitchRateG[1] * pitchRateEint) / 2;
	motors[2] = offset - (rollRateG[0] * rollRateE + rollRateG[1] * rollRateEint) / 2 + (pitchRateG[0] * pitchRateE + pitchRateG[1] * pitchRateEint) / 2;

	//calculate PI for pitch
	motors[1] = offset + (pitchRateG[0] * pitchRateE + pitchRateG[1] * pitchRateEint) / 2 + (rollRateG[0] * rollRateE + rollRateG[1] * rollRateEint) / 2;
	motors[3] = offset - (pitchRateG[0] * pitchRateE + pitchRateG[1] * pitchRateEint) / 2 + (rollRateG[0] * rollRateE + rollRateG[1] * rollRateEint) / 2;
